...
import { formatJesusYear } from "../utils/format";
...
const EventDetails: React.FC<Props> = ({
  ...
  return (
    <div className="absolute bottom-12 left-1/2 -translate-x-1/2 w-[95%] max-w-xl bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-2xl md:rounded-3xl shadow-2xl p-4 md:p-6 z-30 animate-in fade-in slide-in-from-bottom-4 duration-300">
      <button
        onClick={onClose}
